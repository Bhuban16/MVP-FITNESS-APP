...
public class CategoryVideoEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_video_edit);
    ...
    private void UploadFile(){
        if (mImageUri != null   ) {
                    ...
                    filerefernce.putFile(mImageUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Toast.makeText(CategoryVideoEdit.this, "Upload Successful", Toast.LENGTH_LONG).show();
                           /* UploadAdmin upload = new UploadAdmin(mEditText.getText().toString().trim(),
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(CategoryVideoEdit.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                }
                            });
            ...
            DatabaseReference Databaserefernce = FirebaseDatabase.getInstance().getReference("video");
