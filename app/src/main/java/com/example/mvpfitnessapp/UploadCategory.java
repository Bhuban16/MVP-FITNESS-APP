...
public class UploadCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(m.isEmpty() ) {
                   Toast.makeText(UploadCategory.this,"Please type title", Toast.LENGTH_SHORT).show();
                }else if (mImageUri == null){
                        Toast.makeText(UploadCategory.this, "Please choose image",Toast.LENGTH_SHORT).show();
                }else{UploadFile();}
            }
        });
    ...
    private void openImageActivity(){
        Intent intent = new Intent(this,CategoryActivities.class);
    ...
    private void UploadFile(){
        ...
        if (mImageUri != null && mEditText != null) {
            ...
            mUploadTask =
                    filerefernce.putFile(mImageUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Toast.makeText(UploadCategory.this, "Upload Successful", Toast.LENGTH_LONG).show();
                           /* UploadAdmin upload = new UploadAdmin(mEditText.getText().toString().trim(),
                            ...
                            mDatabaserefernce.child(uploadId).setValue(upload);*/
                                    ...
                                    FirebaseCategory upload = new FirebaseCategory(mEditText.getText().toString().trim(), downloadUrl.toString(), mEditText.getText().toString().trim());
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    mProgressbar.setVisibility(View.GONE);
                                    Toast.makeText(UploadCategory.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                }
                            });
                ...
                mProgressbar.setVisibility(View.GONE);
                Toast.makeText(UploadCategory.this, "Please fill all the details", Toast.LENGTH_SHORT).show();
            }
        }}
