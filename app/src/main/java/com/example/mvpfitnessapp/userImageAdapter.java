...
public class userImageAdapter extends RecyclerView.Adapter<userImageAdapter.ImageViewHolder>{
    ...
    private userImageAdapter.OnItemClickListener mListener;

    private FirebaseStorage mStorage;
    private DatabaseReference mDatabaseRef;

    public userImageAdapter(Context context, List<UploadAdmin> uploads) {
        mContext = context;
        mUploads = uploads;
    }

    @Override
    public userImageAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.user_image_item, parent, false);
        return new userImageAdapter.ImageViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder (@NonNull userImageAdapter.ImageViewHolder holder, int position){
        ...
        ((userImageAdapter.ImageViewHolder)holder).card.setOnClickListener(new View.OnClickListener() {
    ...
    public void setOnItemClickListener(userImageAdapter.OnItemClickListener listener) {
        mListener = listener;
    }
